...
<?php	echo $this->header(); ?>
	...
	<meta property="og:image" content="<?php print full_url("resources/images/og_2018.png"); ?>"/>
	...
	<meta name="twitter:image:src" content="<?php print full_url("resources/images/og_2018.png"); ?>"/>
...
<body class="jinbo-net <?php print $breadcrumbs_class; ?>">
	<header id="site-header">
		...
		<ul class="quickLink">
			<li class="cool"><a href="https://www.youtube.com/channel/UCqa8IwsQH3X6FrIda8xyGuQ">유튜브 따오기</a></li>
