...
<article class="icon-headline-link component <?php print $classes; ?>" style="<?php print $style; ?>">
	<div class="article-inner">
		<div class="featured" data-align="<?php print $data['media']['align']; ?>">
<?php	if($data['media']) {?>
...
<?php	}?>
		...
		<div class="content">
			<div class="content-inner">
				<div class="header">
					<h3><a href="<?php print $data['url']['href']; ?>" target="<?php print $data['url']['target']; ?>"><?php print $data['before'].$data['subject']; ?></a></h3>
