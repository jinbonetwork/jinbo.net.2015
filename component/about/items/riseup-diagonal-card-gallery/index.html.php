...
<article class="riseup-diagonal-card-gallery component triangle outer-before outer-after <?php print $classes; ?>" style="<?php print $style; ?>" data-triangle-outer-before-ratio="0.20" data-triangle-outer-before-shape="bottom-left" data-triangle-outer-after-ratio="0.12" data-triangle-outer-after-shape="top-left">
	<div class="header">
...
<?php		if($data['data'][$i]['media']['url']) {?>
				<div class="featured-inner triangle inner-before inner-after" data-triangle-inner-before-ratio="0.10" data-triangle-inner-before-shape="top-left" data-triangle-inner-after-ratio="0.10" data-triangle-inner-after-shape="bottom-right">
